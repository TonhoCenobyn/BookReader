...
<div class="container">
    ...
    <form action="cadastroLivro" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" placeholder="autor" name="autor" class="form-control" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Preço do livro:</label>
            <input type="number" step="0.01" placeholder="preco" name="preco" class="form-control" required>
        </div>
        <div class="mb-3">
        ...
        <input hidden="hidden" name="opcao" value="cadastrar">
        <button type="submit" class="btn btn-primary">Cadastrar livro</button>
    </form>
    <a href="cadastroLivro?redirect=dashboard">Cancelar cadastro</a>
