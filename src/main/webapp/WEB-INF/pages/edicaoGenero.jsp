...
<jsp:useBean id="dao" class="dao.GeneroDAO"/>
<html>
...
<div class="container">
  ...
  <form action="genero" method="post">
    <div class="mb-3">
      ...
      <input value="<c:out value="${dao.getGenero(id).nome}"/>" type="text" placeholder="titulo" name="nome" class="form-control" required>
    </div>
    <input hidden="hidden" name="id" value="<c:out value="${id}"/>">
    <input hidden="hidden" name="opcao" value="editar">
    <button type="submit" class="btn btn-primary">Salvar alterações</button>
  </form>
  <a href="cadastroLivro?redirect=generos">Cancelar edição</a>
